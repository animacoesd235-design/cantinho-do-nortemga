      ...
      <body>
        ...
        <noscript>
          <img
            ...
            width="1"
            style={{ display: "none" }}
            src="https://www.facebook.com/tr?id=1730334224937135&ev=PageView&noscript=1"
            alt=""
          />
        </noscript>
        {children}
...
function RootComponent() {
  ...
  // Rastreia PageView em transições de rotas no SPA (sem duplicar na carga inicial)
  useEffect(() => {
